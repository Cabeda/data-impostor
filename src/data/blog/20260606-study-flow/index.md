---
title: "RSS, Read-It-Later, and the Art of Not Drowning in the feed era"
pubDate: 2026-06-06
heroImage: 
heroImageAlt: 
tags:
...
So, in terms of stack I'm quite happy, I've got some minor bugs that I've opened issues to fix and the main complaint I had of not having offline reading has been fixed by both IOS and android app clients. Neat! But the major pain point, the studying flow is something that has helped me greatly to keep my knowledge in check. I feel constantly humbled by the things I don't know and the trimming process of articles means that I'm not burning out. This can be tricky as I always feel that I should read everything but we only have 24 hours and there is more to do than read articles.

It's not perfect , I tend to get +100 articles without trimming, ~50 after doing it and I think that I should strive to get something like 20 articles or the equivalente to at most to 7 hours of reading per week. This is a lot of reading being done but it's what I'm actually capable of. Worse if I decide to pick on a book or paper to read that require more intensive focus. 
